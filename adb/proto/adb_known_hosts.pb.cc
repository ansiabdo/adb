...
extern PROTOBUF_INTERNAL_EXPORT_adb_5fknown_5fhosts_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HostInfo_adb_5fknown_5fhosts_2eproto;
namespace adb {
namespace proto {
...
static void InitDefaultsscc_info_AdbKnownHosts_adb_5fknown_5fhosts_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AdbKnownHosts_adb_5fknown_5fhosts_2eproto =
    {{{::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized}, 1, InitDefaultsscc_info_AdbKnownHosts_adb_5fknown_5fhosts_2eproto}, {
      &scc_info_HostInfo_adb_5fknown_5fhosts_2eproto.base,}};

static void InitDefaultsscc_info_HostInfo_adb_5fknown_5fhosts_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_HostInfo_adb_5fknown_5fhosts_2eproto =
    {{{::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized}, 0, InitDefaultsscc_info_HostInfo_adb_5fknown_5fhosts_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_adb_5fknown_5fhosts_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_adb_5fknown_5fhosts_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_adb_5fknown_5fhosts_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_adb_5fknown_5fhosts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::adb::proto::HostInfo, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::adb::proto::HostInfo, guid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::adb::proto::AdbKnownHosts, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::adb::proto::AdbKnownHosts, host_infos_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::adb::proto::HostInfo)},
  { 6, -1, sizeof(::adb::proto::AdbKnownHosts)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::adb::proto::_HostInfo_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::adb::proto::_AdbKnownHosts_default_instance_),
};
...
const char descriptor_table_protodef_adb_5fknown_5fhosts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_adb_5fknown_5fhosts_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_adb_5fknown_5fhosts_2eproto_sccs[2] = {
  &scc_info_AdbKnownHosts_adb_5fknown_5fhosts_2eproto.base,
  &scc_info_HostInfo_adb_5fknown_5fhosts_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_adb_5fknown_5fhosts_2eproto_once;
static bool descriptor_table_adb_5fknown_5fhosts_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_adb_5fknown_5fhosts_2eproto = {
  &descriptor_table_adb_5fknown_5fhosts_2eproto_initialized, descriptor_table_protodef_adb_5fknown_5fhosts_2eproto, "adb_known_hosts.proto", 179,
  &descriptor_table_adb_5fknown_5fhosts_2eproto_once, descriptor_table_adb_5fknown_5fhosts_2eproto_sccs, descriptor_table_adb_5fknown_5fhosts_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_adb_5fknown_5fhosts_2eproto::offsets,
  file_level_metadata_adb_5fknown_5fhosts_2eproto, 2, file_level_enum_descriptors_adb_5fknown_5fhosts_2eproto, file_level_service_descriptors_adb_5fknown_5fhosts_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_adb_5fknown_5fhosts_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_adb_5fknown_5fhosts_2eproto), true);
namespace adb {
namespace proto {
...
void HostInfo::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_HostInfo_adb_5fknown_5fhosts_2eproto.base);
  guid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(mutable_guid(), ptr, ctx, "adb.proto.HostInfo.guid");
          CHK_(ptr);
...
// @@protoc_insertion_point(generalized_merge_from_start:adb.proto.HostInfo)
  GOOGLE_DCHECK_NE(&from, this);
  const HostInfo* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<HostInfo>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:adb.proto.HostInfo)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:adb.proto.HostInfo)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:adb.proto.HostInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void AdbKnownHosts::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AdbKnownHosts_adb_5fknown_5fhosts_2eproto.base);
}
...
::PROTOBUF_NAMESPACE_ID::uint8* AdbKnownHosts::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  ...
  for (unsigned int i = 0,
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessageToArray(
        1, this->host_infos(static_cast<int>(i)), target);
  }
...
void AdbKnownHosts::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:adb.proto.AdbKnownHosts)
  GOOGLE_DCHECK_NE(&from, this);
  const AdbKnownHosts* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<AdbKnownHosts>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:adb.proto.AdbKnownHosts)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:adb.proto.AdbKnownHosts)
    MergeFrom(*source);
  }
}
...
void AdbKnownHosts::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:adb.proto.AdbKnownHosts)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
