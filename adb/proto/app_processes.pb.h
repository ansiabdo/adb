...
class ProcessEntry :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_app_5fprocesses_2eproto);
    return ::descriptor_table_app_5fprocesses_2eproto.file_level_metadata[kIndexInFileMessages];
  }
