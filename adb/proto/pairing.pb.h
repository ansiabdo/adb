...
class PairingPacket :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:adb.proto.PairingPacket) */ {
 public:
  PairingPacket();
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_pairing_2eproto.file_level_metadata[kIndexInFileMessages];
  }
