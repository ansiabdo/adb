...
class HostInfo :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_adb_5fknown_5fhosts_2eproto);
    return ::descriptor_table_adb_5fknown_5fhosts_2eproto.file_level_metadata[kIndexInFileMessages];
  }
